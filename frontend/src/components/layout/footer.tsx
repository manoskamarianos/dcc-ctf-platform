            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
                    ...
                    <div className="flex flex-col space-y-3">
                        ...
                        <p className="text-gray-400 text-sm">
                            Practice your cybersecurity skills with daily CTF
                            challenges. Learn, compete, and climb the
                            leaderboard.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <Button
                                variant="link"
                                className="justify-start text-gray-400 hover:text-terminal-green p-0 h-auto"
                                asChild
                            >
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-4 text-sm text-gray-400">
                        <Button
                            variant="link"
                            className="text-gray-400 hover:text-terminal-green p-0 h-auto"
                            asChild
                        >
